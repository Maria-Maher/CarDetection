...
DataMode= 1  #1) is existing classifier  2) is building a classifier
...
if (DataMode == 1):
    ...
    for image in car_images:
        cars.append(image)
    print('cars append is done')


    for image in noncar_images:
        notcars.append(image)
    print('notcars append is done')
            # set the sample size
